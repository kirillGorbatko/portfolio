...
let slider_tabs = new Swiper('.tabs-trips__nav', {
	slidesPerView: 10,
	spaceBetween: 16,
	breakpoints: {
		320: {
...
let cards = document.querySelectorAll('.tabs-trips__row');
	let slider_card = new Swiper(cards, {
		observer: true,
		observeParents: true,
		allowSlidePrev: false,
		allowSlideNext: false,
		pagination : {
				el: '.tabs-trips__fraction',
				type: 'fraction',
			},
	breakpoints: {
		1356: {
...
let slider_offers = new Swiper('.offers__row', {
	slidesPerView: 2,
	observer: true,
	observeParents: true,
	autoHeight: true,
