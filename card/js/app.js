...
function setScrollType() {
	if (wrapper.classList.contains('_free')) {
		...
		pageSlider.params.sticky = false;
		pageSlider.params.momentumBounce = false;
		pageSlider.params.momentum = false;
	}
	for (let index = 0; index < pageSlider.slides.length; index++) {
		...
		if (pageSlideContent) {
			...
			if (pageSlideContentHeight > window.innerHeight) {
				...
				pageSlider.params.sticky = true;
				pageSlider.params.momentumBounce = true;
				pageSlider.params.momentum = true;
				break;
			}
		}
	}
