          ...
          if (formsModules.selectModule) {
            ...
            if (t.length)
              for (let e = 0; e < t.length; e++) {
                ...
                formsModules.selectModule.selectBuild(s);
              }
          }
        }, 0);
    },
    ...
    !(function () {
      ...
      document.querySelector(".products__slider") &&
        new le(".products__slider", {
          ...
          speed: 800,
          navigation: {
            nextEl: ".products__controls .controls__arrow_next",
            prevEl: ".products__controls .controls__arrow_prev",
          },
          breakpoints: {
      ...
      document.querySelector(".reviews__slider") &&
        new le(".reviews__slider", {
          ...
          speed: 800,
          navigation: {
            nextEl: ".reviews__controls .controls__arrow_next",
            prevEl: ".reviews__controls .controls__arrow_prev",
          },
        });
  }
    ...
    (function (e) {
      ...
      async function s(t, s) {
        if (0 === (e ? c.getErrors(t) : 0)) {
          ...
          e && t.hasAttribute("data-goto-error") && gotoBlock(e, !0, 1e3);
        }
      }
      function i(e) {
        document.dispatchEvent(
